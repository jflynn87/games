...
class ESPNGolfer(object):
    ...
    def __init__(self, espn_num):
        ...
        if espn_num:
            ...
            #season is based on the fall start, so runs one behind our game
            url =  "http://sports.core.api.espn.com/v2/sports/golf/leagues/pga/seasons/" + str(s.season-1) + "/types/2/athletes/" + espn_num + "/statistics/0?lang=en&region=us"

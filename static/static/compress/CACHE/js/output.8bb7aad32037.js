...
circle.classList.add('fa','fa-info-circle')
circle.style.color='blue'
recent_form.tooltip={trigger:"hover",delay:{"show":400,"hide":800},"title":items}
recent_form.innerText=ranks
recent_form.appendChild(circle)

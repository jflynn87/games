...
Promise.all([fetch("/golf_app/get_info"+$('#tournament_key').text()).then(resp=>resp.json()),fetch("/golf_app/get_picks").then(resp=>resp.json())]).then((response)=>resp.json()).then((responseJSON)=>{info=$.parseJSON(responseJSON)

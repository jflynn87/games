...
checkStarted()}))})})
function build_field(g,info,picks){return new Promise(function(resolve,reject){$('#field_sect #pick_form').append('<table id=tbl-group-'+g+' class=table> \
...
get_info(info,this);});console.log(field.playerName,Object.values(picks.id).indexOf(field.id))

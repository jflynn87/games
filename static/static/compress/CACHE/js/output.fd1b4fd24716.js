...
console.log(field.recent)
for(let i=0;i<rec_l;i++){console.log(Object.values(field.recent)[i])
if(i+1<rec_l){ranks+=Object.values(field.recent)[i].rank+', '}
else{ranks+=Object.values(field.recent)[i].rank}
items+=Object.values(field.recent)[i].name+': '+Object.values(field.recent)[i].rank+'\n'}

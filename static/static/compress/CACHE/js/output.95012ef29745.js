...
if(indicator="Show Golfer Stats"){console.log(document.getElementById('stats_row-'+field.id))
$('#stats_row'+field.id+' .stats_row').attr('hidden',false)
$('#expand-'+field.id).html('Hide Golfer Stats')}

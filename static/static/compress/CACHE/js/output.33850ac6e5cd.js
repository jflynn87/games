...
recent_dtl=document.createElement('span')
recent_tt=document.createElement('a')
recent_circle=document.createElement('i')
recent_tt.id='tt-recent'+field.id
recent_tt.dataToggle='tooltip'
recent_tt.html=true
recent_circle.classList.add('fa','fa-info-circle')
recent_circle.style.color='blue'
recent_form.style.tooltip={trigger:"hover",delay:{"show":400,"hide":800},"title":items}
recent_form.appendChild(recent_dtl)
recent_form.appendChild(recent_tt)
recent_form.appendChild(recent_circle)

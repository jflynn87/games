...
expand.addEventListener('click',function(field.id){toggle_golfer_stats(field.id)})
...
function toggle_golfer_stats(field_id){indicator=document.getElementById('expan-'+field.id).innerHTML.trim()
if(indicator="Show Golfer Stats"){document.getElementById('player-'+field.id+'-div').getElementsByClassName('stats_row').hidden=false
document.getElementById('expan-'+field.id).innerHTML="Hide Golfer Stats"}
document.getElementById('player-'+field.id+'-div').getElementsByClassName('stats_row').hidden=true
document.getElementById('expan-'+field.id).innerHTML="Show Golfer Stats"};
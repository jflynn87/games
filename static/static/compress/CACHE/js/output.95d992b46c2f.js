...
else if(field.started){golfer.creteTextNode('Started')}
else{golfer.createTextNode('Problem')}
...
text=document.createTextNode(field.playerName+' ')
golfer.appendChild(text)

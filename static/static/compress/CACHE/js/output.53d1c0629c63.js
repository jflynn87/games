...
$('#expand-grp-'+g).on('click',function(){toggle_stats_display($('#tbl-group-'+g))})
...
return stats_row}
function toggle_stats_display(table){console.log('togglng ',table[0])
table_l=table[0].rows.length
$('table.stats_row').attr('hidden',false)};
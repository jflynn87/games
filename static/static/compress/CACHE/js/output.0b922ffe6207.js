...
let inputB=document.querySelector('input');inputB.id=field.id
inputB.type=input_type
inputB.classList.add(input_class)
inputB.name="group-"+field.group.number
inputB.value=field.id
inputB.addEventListener('change',function(){console.log('click happened!');});golfer.appendChild(inputB)}

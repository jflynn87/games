...
rowD_header_filds=['Played','Won','2-10','11-29','30-49','50','Cuts']
rowD_field_l=rowB_header_fields.length
rowD_header_cells=[]
...
for(let i=0;i<rowB_field_l;i++){rowD_header.append(rowB_header_cells[i])}
...
let cellF=document.createElement('td')
cellF.colSpan=1
cellF.innerHTML=field.season_stats.cuts
stats_rowD.appendChild(cellF)

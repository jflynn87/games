...
expand.addEventListener('click',function(expand){toggle_golfer_stats(expand)})
...
return stats_row}
function toggle_stats_display(ele,table){table_l=table[0].rows.length
t_id=table[0].id
...
function toggle_golfer_stats(evt){console.log('exp golfer ',evt)};
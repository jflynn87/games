...
golfer_row_owgr=document.createElement('td')
golfer_row_owgr.innerHTML='OWGR: '+field.currentWGR
golfer_row_owgr.colSpan=2
golfer_row_handicap=document.createElement('td')
golfer_row_handicap.innerHTML="Handicap: "+field.handi
golfer_row_handicap.colSpan=2
golfer_row_prior_year=document.createElement('td')
golfer_row_prior_year.innerHTML="Prior Year: "+field.prior_year
golfer_row_prior_year.colSpan=2
golfer_row.appendChild(golfer)
golfer_row.appendChild(golfer_row_owgr)
golfer_row.appendChild(golfer_row_handicap)
golfer_row.appendChild(golfer_row_prior_year)
return golfer_row}
function build_stats_row(field){let stats_row=document.createElement('tr');stats_row.classList.add('stats_row')

...
if(indicator="Show Golfer Stats"){console.log(document.getElementById('stats_row-'+field.id).hidden)
$('#stats_row'+field.id).attr('hidden',false)
$('#expande-'+field.id).innerHTML('Hide Golfer Stats')
document.getElementById('expand-'+field.id).innerHTML="Hide Golfer Stats"}
document.getElementById('stats_row-'+field.id).hidden=true

...
field_row=document.createElement('tr')
field_table.append(field_row)
let golfer=build_golfer_row(field,pick_array)
console.log('golferL ',golfer)
...
function build_golfer_row(field,pick_array){return new Promise(function(resolve,reject){let field_row=document.createElement('tr')

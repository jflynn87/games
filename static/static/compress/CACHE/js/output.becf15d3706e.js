...
document.getElementById('player-'+field.golfer.espn_number+'-div').classList.add('top_row')}
...
let stats_table=document.createElement('table');stats_table.classList.add('table')
...
stats_table.appendChild(stats_RowC)'<tr>'+'<td>Played</td>'+'<td>Won</td>'+'<td>2-10</td>'+'<td>11-29</td>'+'<td>30-49</td>'+'<td>> 50</td>'+'<td>Cuts</td>'+'</tr>'+'<tr>'+'<td>'+field.season_stats.played+'</td>'+'<td>'+field.season_stats.won+'</td>'+'<td>'+field.season_stats.top10+'</td>'+'<td>'+field.season_stats.bet11_29+'</td>'+'<td>'+field.season_stats.bet30_49+'</td>'+'<td>'+field.season_stats.over50+'</td>'+'<td>'+field.season_stats.cuts+'</td>'+'<td></td>'+'</tr>'+
stats_row.append(stats_table)

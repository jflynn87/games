...
else if(field.started){var status='Started'+' '
...
expand.classList.add('fa','fa-plus-circle')
...
return golfer_row}
function build_stats_row(field){let stats_row=document.createElement('tr');stats_row.setAttribute('hidden',true)
...
function toggle_golfer_stats(field_id){indicator=document.getElementById('expand-'+field.id).innerHTML.trim()
console.log('indicator ',indicator)
if(indicator="Show Golfer Stats"){console.log(document.getElementById('player-'+field.id+'-div').getElementsByClassName('stats_row').style.display)
document.getElementById('player-'+field.id+'-div').getElementsByClassName('stats_row').hidden=false
document.getElementById('expand-'+field.id).innerHTML="Hide Golfer Stats"}
document.getElementById('player-'+field.id+'-div').getElementsByClassName('stats_row').hidden=true
document.getElementById('expand-'+field.id).innerHTML="Show Golfer Stats"};
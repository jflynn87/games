...
let stats_row=document.createElement('tr');let stats_table=document.createElement('table');let rowA_header_fields=['Current OWGR','Last Week OWGR','Last Season OWGR','FedEx Cup']
...
currOWGR.innerHTML=field.currOWGR
...
strats_table.appendChild(stats_rowA)
strats_table.appendChild(stats_rowB)
strats_table.appendChild(stats_rowC)
strats_table.appendChild(stats_rowD)
stats_row.appendChild(stats_table)

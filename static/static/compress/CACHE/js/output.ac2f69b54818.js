...
get_info(info,this);});console.log(field.id,' ',pick_array)
if(pick_array.indexOf(Object.keys(field.id))!=-1){console.log('found pick',pick_array.indexOf(Object.keys(field.id)))
inputB.checked=true}

...
console.log(table[0].getElementsByClassName('top_row').length)
for(let i=0;i<table[0].getElementsByClassName('top_row').length;i++){console.log('table: ',table[0].getElementsByClassName('top_row')[i])}}

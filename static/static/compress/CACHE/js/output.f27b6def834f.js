...
for(let i=0;i<rec_l;i++){console.log(Object.keys(field.recent)[i])
if(i+1<rec_l){ranks+=Object.keys(field.recent)[i].rank+', '}
else{ranks+=Object.keys(field.recent)[i].rank}}
var items=''

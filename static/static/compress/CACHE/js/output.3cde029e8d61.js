...
let cell=document.createElement('th')
cell.innerHTML='Shots Gained Stats'
cell.colSpan=8
cell.classList.add('stats_row')
sg_row.appendChild(cell)
...
for(let i=0;i<rowE_field_l;i++){rowD_header.append(rowE_header_cells[i])}
let stats_rowE=document.createElement('tr')
let cellE=document.createElement('td')
cellE.innerHTML=field.season_stats.played
stats_rowE.appendChild(cellA)

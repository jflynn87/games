...
var ranks=''
console.log('recent l',Object.keys(field.recent).length)
$.each(field.recent,function(i,rank){if(i<Object.keys(field.recent).length){ranks+=rank.rank+', '}
else{ranks+=rank.rank}})
var items=''

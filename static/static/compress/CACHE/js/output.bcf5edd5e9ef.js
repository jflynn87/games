...
if(!field.withdrawn&&!field.started){let inputA=document.createElement('input');input.type='hidden';input.name="csrfmiddlewaretoken";input.value=$.cookie('csrftoken')
...
golfer.innerHTML=''}
else if(field.withdrawn){golfer.innerHTML='WD'}
...
pga.innerHTML="PGA"
golfer.append(img)
golfer.innerHTML=field.playerName
golfer.append(flag)

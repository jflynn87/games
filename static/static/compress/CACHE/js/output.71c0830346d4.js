...
if(indicator="Show Golfer Stats"){console.log(document.getElementById('stats_row-'+field_id))
document.getElementById('stats_row-'+field_id).style.visibility="visible";document.getElementById('expand-'+field_id).innerHTML="Hide Golfer Stats"}
document.getElementById('stats_row-'+field_id).hidden=true

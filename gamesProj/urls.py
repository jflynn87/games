...
urlpatterns = [
    ...
    re_path(r'^$', user_views.index,name='index'),
    #url(r'^register/$',main_views.register,name='register'),
    #url(r'^', include('django.contrib.auth.urls')),
    re_path(r'^signup/$', user_views.SignUp.as_view(),name='signup'),
    #url(r'^login/$', auth_views.LoginView.as_view(template_name='main_app/templates/login.html'),name='login'),
    #url(r'^logout/$', auth_views.LogoutView.as_view(),name='logout'),
    re_path(r'^fb_app/', include('fb_app.urls',namespace='fb_app')),
    re_path(r'^golf_app/', include('golf_app.urls',namespace='golf_app')),
